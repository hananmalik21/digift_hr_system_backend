...
export function varcharInBind(value, maxSize = 200) {
  return {
    val: strOrNull(value),
    dir: oracledb.BIND_IN,
    type: oracledb.STRING,
...
export function auditInBind(value) {
  return varcharInBind(toAuditActorId(value ?? 'SYSTEM'), 200);
}

export function numberInBind(value) {
  return {
    val: numOrNull(value),
    dir: oracledb.BIND_IN,
...
export function enterpriseIdInBind(value) {
  return {
    val: value,
    dir: oracledb.BIND_IN,
    type: oracledb.NUMBER
...
export function guidHexInBind(value, maxSize = 32) {
  return {
    val: value,
    dir: oracledb.BIND_IN,
    type: oracledb.STRING,
...
export function activeFlagInBind(value) {
  return ynInBind(value, null);
}

export function outNumberBind() {
  return { dir: oracledb.BIND_OUT, type: oracledb.NUMBER };
}

export function outGuidHexBind(maxSize = 32) {
  return { dir: oracledb.BIND_OUT, type: oracledb.STRING, maxSize };
}

export function clobJsonInBind(value) {
  return {
 ...
 * @returns {never}
 */
export function wrapOracleDbError(err) {
  if (
  ...
  throw new DatabaseError(oraclePlsqlErrorMessage(err), err);
}
