...
/**
 * Send list of lookup values
 * @param {Object} res - Express response object
 * @param {Object} req - Express request object
 * @param {Array} values - Array of lookup values
...
/**
 * Send single lookup value
 * @param {Object} res - Express response object
 * @param {Object} req - Express request object
 * @param {Object|null} value - Lookup value object or null
 */
 ...
 * @param {Object} res - Express response object
 * @param {Object} req - Express request object
 * @param {Object} value - Created lookup value
 */
 ...
 * @param {Object} res - Express response object
 * @param {Object} req - Express request object
 * @param {Object} value - Updated lookup value
 */
export function sendUpdated(res, req, value) {
  ...
  res.json({
    ...
    meta: generateBaseMetadata(req, {
      ...
      lookup_value_id: convertedValue.lookup_value_id || value.LOOKUP_VALUE_ID,
      action: 'updated'
      // Note: LAST_UPDATE_DATE column doesn't exist in ABS_LOOKUP_VALUES table
      // If the column is added later, uncomment:
      // last_updated: convertedValue.last_update_date || value.LAST_UPDATE_DATE
    }),
    data: convertedValue
  });
}
 ...
 * @param {number} valueId - Deleted value ID
 */
