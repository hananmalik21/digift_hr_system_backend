...
|-------|---------|-----------|------|--------|
| TM | TM_PAYROLL_HOURLY_RATE_POLICY_PKG | CREATE_OR_UPSERT_HOURLY_RATE_POLICY | POST/PUT /time-management/hourly-rate-policies | EXPOSED |
...
| TM | TM_PAYROLL_TRANSFER_PROCESSING_PKG | CREATE_OR_UPSERT_SOURCE_MAPPING | POST/PUT/PATCH source-mappings | EXPOSED |
