...
CREATE OR REPLACE PACKAGE REC.CANDIDATE_PKG AS
  ...
  PROCEDURE CREATE_CANDIDATE (
    ...
    p_visa_status         IN  VARCHAR2 DEFAULT NULL,
    p_alternate_phone     IN  VARCHAR2 DEFAULT NULL,
    p_alternate_email     IN  VARCHAR2 DEFAULT NULL,
    p_preferred_location  IN  VARCHAR2 DEFAULT NULL,
    p_source_from         IN  VARCHAR2 DEFAULT NULL,
    p_education_json      IN  CLOB     DEFAULT NULL,
    p_experience_json     IN  CLOB     DEFAULT NULL,
    p_skills_json         IN  CLOB     DEFAULT NULL,
