...
function buildSql() {
  // Notes:
  // - `COMP_EMP_ASSIGNED_COMPONENTS_V` is the source of assignments + existing filters.
  // - `COMP_PLAN_COMPONENTS` provides `frequency_code` and can have duplicates; pick latest by PLAN_COMPONENT_ID.
  return `
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      // Keep this endpoint's error response consistent and non-leaky.
      return sendFailure(
        res,
        HTTP.SERVER_ERROR,
