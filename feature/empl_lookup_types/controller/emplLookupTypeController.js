...
/**
 * @route   GET /api/empl/lookup-types
 * @desc    Get all lookup types with optional filtering and pagination
 * @query   enterprise_id, is_active, search, page, page_size
 */
...
/**
 * @route   GET /api/empl/lookup-types/:guid
 * @desc    Get a single lookup type by GUID
 */
...
/**
 * @route   POST /api/empl/lookup-types
 * @desc    Create a new lookup type
 * @body    { type_code, type_name, enterprise_id?, is_active? }
 */
...
/**
 * @route   PUT /api/empl/lookup-types/:guid
 * @desc    Update a lookup type by GUID
 * @body    { type_code?, type_name?, enterprise_id?, is_active? }
 */
...
/**
 * @route   DELETE /api/empl/lookup-types/:guid
 * @desc    Delete a lookup type by GUID (hard delete)
 */
