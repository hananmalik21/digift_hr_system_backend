...
class EmplLookupTypeModel {
  ...
  /**
   * Get all lookup types with optional filters and pagination
   * @param {Object} filters - Optional filters (enterpriseId, isActive, search, pagination)
   * @returns {Promise<Object>} Object with {lookupTypes, total}
   */
  ...
  /**
   * Get a single lookup type by GUID
   * @param {string} guidHex32 - Lookup Type GUID (32-hex string)
   * @returns {Promise<Object|null>} Lookup type object or null
   */
   ...
   * @param {Object} data - Lookup type data
   * @param {string} userId - User ID for audit fields
   * @returns {Promise<Object>} Created lookup type
   */
  static async create(data, userId) {
    try {
      return await this.executeWithTransaction(async (connection) => {
        let lookupTypeId;
        try {
          const seqQuery = `SELECT EMPL.EMPL_LOOKUP_TYPES_SEQ.NEXTVAL AS NEXT_ID FROM DUAL`;
  ...
  /**
   * Update a lookup type by GUID
   * @param {string} guidHex32 - Lookup Type GUID (32-hex string)
   * @param {Object} data - Data to update
   * @param {string} userId - User ID for audit fields
   * @returns {Promise<Object>} Updated lookup type
   */
  ...
  /**
   * Delete a lookup type by GUID (hard delete)
   * @param {string} guidHex32 - Lookup Type GUID (32-hex string)
...
export default EmplLookupTypeModel;
