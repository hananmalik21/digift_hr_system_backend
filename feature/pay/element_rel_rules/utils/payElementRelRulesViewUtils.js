...
export const VIEW_ROW_FORMAT = { outFormat: oracledb.OUT_FORMAT_OBJECT };
...
export async function executeViewQuery(sql, binds, context) {
  ...
  try {
    ...
    return await connection.execute(sql, binds, VIEW_ROW_FORMAT);
  } catch (err) {
...
export function mapGuidField(value) {
  return normalizeOutGuidHex(value);
}
