...
import { GENERIC_TECHNICAL_ERROR } from '../constants/payCostingAllocations.constants.js';
import { firstValidationMessage } from '../validations/payCostingAllocations.validation.js';
...
export async function withCostingAllocationsErrorHandling(res, work) {
  try {
    return await work();
  } catch (err) {
