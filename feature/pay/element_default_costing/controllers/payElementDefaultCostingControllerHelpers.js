...
import { GENERIC_TECHNICAL_ERROR } from '../constants/payElementDefaultCosting.constants.js';
import { firstValidationMessage } from '../validations/payElementDefaultCosting.validation.js';
...
export async function withElementDefaultCostingErrorHandling(res, work) {
  try {
    return await work();
  } catch (err) {
