...
export function parseElementDefaultCostingGuidParam(raw) {
  return parseGuid(raw, 'elementDefaultCostingGuid');
}
...
export function validateListElementDefaultCostingQuery(query = {}, req) {
  const errors = [];
  ...
  const element_type = parseOptionalUppercaseCode(errors, query.element_type, 'element_type');
...
export function validateGetElementDefaultCostingByGuidQuery(query = {}, req) {
  const errors = [];
  const enterprise_id = resolveRequiredEnterpriseIdFromQuery(req, query.enterprise_id, errors);
  throwIfErrors(errors);
  return { enterprise_id };
...
export function validateCreateElementDefaultCostingBody(body = {}, _req) {
  const errors = [];
...
export function validateUpdateElementDefaultCostingBody(body = {}, _req) {
  const errors = [];
...
export function validateDeleteElementDefaultCostingBody(_body = {}, _query = {}) {
  return {};
}
