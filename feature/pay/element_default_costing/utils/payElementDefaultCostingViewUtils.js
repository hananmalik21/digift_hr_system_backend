...
export function mapElementDefaultCostingGridRow(row, parsedFlexfieldSegments, parsedFlexfieldSegmentsDetails) {
  const r = rowKeysUpper(row);
  return {
    element_default_costing_id: toNumberOrNull(r.ELEMENT_DEFAULT_COSTING_ID),
    element_default_costing_guid: normalizePayViewGuid(r.ELEMENT_DEFAULT_COSTING_GUID),
    ...
    element_type: toStringOrNull(r.ELEMENT_TYPE),
 ...
 */
export function mapElementDefaultCostingDetailRow(row, parsedFlexfieldSegments, parsedFlexfieldSegmentsDetails) {
  const r = rowKeysUpper(row);
  return {
    element_default_costing_id: toNumberOrNull(r.ELEMENT_DEFAULT_COSTING_ID),
    element_default_costing_guid: normalizePayViewGuid(r.ELEMENT_DEFAULT_COSTING_GUID),
