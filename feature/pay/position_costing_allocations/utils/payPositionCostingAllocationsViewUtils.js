...
export function mapPositionCostingGridRow(row, parsedFlexfieldSegments, parsedFlexfieldSegmentsDetails) {
  const r = rowKeysUpper(row);
  return {
    position_costing_id: toNumberOrNull(r.POSITION_COSTING_ID),
    position_costing_guid: normalizePayViewGuid(r.POSITION_COSTING_GUID),
 ...
 */
export function mapPositionCostingDetailRow(row, parsedFlexfieldSegments, parsedFlexfieldSegmentsDetails) {
  const r = rowKeysUpper(row);
  return {
    position_costing_id: toNumberOrNull(r.POSITION_COSTING_ID),
    position_costing_guid: normalizePayViewGuid(r.POSITION_COSTING_GUID),
