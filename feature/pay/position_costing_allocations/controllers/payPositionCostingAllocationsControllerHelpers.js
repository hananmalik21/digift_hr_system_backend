...
import { GENERIC_TECHNICAL_ERROR } from '../constants/payPositionCostingAllocations.constants.js';
import { firstValidationMessage } from '../validations/payPositionCostingAllocations.validation.js';
...
export async function withPositionCostingAllocationsErrorHandling(res, work) {
  try {
    return await work();
  } catch (err) {
