...
import { GENERIC_TECHNICAL_ERROR } from '../constants/payEmpElementCostingAllocations.constants.js';
import { firstValidationMessage } from '../validations/payEmpElementCostingAllocations.validation.js';
...
export async function withEmpElementCostingAllocationsErrorHandling(res, work) {
  try {
    return await work();
  } catch (err) {
