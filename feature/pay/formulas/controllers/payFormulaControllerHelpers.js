...
import { GENERIC_TECHNICAL_ERROR } from '../model/payFormulasModel.js';
import { firstValidationMessage } from '../validations/payFormulas.validation.js';
...
export async function withPayFormulaErrorHandling(res, work) {
  try {
    return await work();
  } catch (err) {
