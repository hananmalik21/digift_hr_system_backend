...
import { firstValidationMessage } from '../validations/payBalanceDefinitions.validation.js';
...
export async function withPayBalanceDefinitionErrorHandling(res, work) {
  try {
    return await work();
  } catch (err) {
