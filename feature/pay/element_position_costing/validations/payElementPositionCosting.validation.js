...
export function parseElementPositionCostingGuidParam(raw) {
  return parseGuid(raw, 'elemPositionCostingGuid');
}
...
export function validateListElementPositionCostingQuery(query = {}, req) {
  const errors = [];
...
export function validateGetElementPositionCostingByGuidQuery(query = {}, req) {
  const errors = [];
  const enterprise_id = resolveRequiredEnterpriseIdFromQuery(req, query.enterprise_id, errors);
  throwIfErrors(errors);
  return { enterprise_id };
...
export function validateCreateElementPositionCostingBody(body = {}, _req) {
  const errors = [];
...
export function validateUpdateElementPositionCostingBody(body = {}, _req) {
  const errors = [];
...
export function validateDeleteElementPositionCostingBody(_body = {}, _query = {}) {
  return {};
}
