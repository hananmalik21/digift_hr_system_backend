...
import { GENERIC_TECHNICAL_ERROR } from '../constants/payElementPositionCosting.constants.js';
import { firstValidationMessage } from '../validations/payElementPositionCosting.validation.js';
...
export async function withElementPositionCostingErrorHandling(res, work) {
  try {
    return await work();
  } catch (err) {
