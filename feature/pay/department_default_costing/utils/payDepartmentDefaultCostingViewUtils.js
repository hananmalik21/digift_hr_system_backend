...
export function mapDepartmentDefaultCostingGridRow(row, parsedFlexfieldSegments, parsedFlexfieldSegmentsDetails) {
  const r = rowKeysUpper(row);
  return {
    dept_default_costing_id: toNumberOrNull(r.DEPT_DEFAULT_COSTING_ID),
    dept_default_costing_guid: normalizePayViewGuid(r.DEPT_DEFAULT_COSTING_GUID),
 ...
 */
export function mapDepartmentDefaultCostingDetailRow(row, parsedFlexfieldSegments, parsedFlexfieldSegmentsDetails) {
  const r = rowKeysUpper(row);
  return {
    dept_default_costing_id: toNumberOrNull(r.DEPT_DEFAULT_COSTING_ID),
    dept_default_costing_guid: normalizePayViewGuid(r.DEPT_DEFAULT_COSTING_GUID),
