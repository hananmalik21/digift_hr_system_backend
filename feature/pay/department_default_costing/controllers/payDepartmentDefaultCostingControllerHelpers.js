...
import { GENERIC_TECHNICAL_ERROR } from '../constants/payDepartmentDefaultCosting.constants.js';
import { firstValidationMessage } from '../validations/payDepartmentDefaultCosting.validation.js';
...
export async function withDepartmentDefaultCostingErrorHandling(res, work) {
  try {
    return await work();
  } catch (err) {
