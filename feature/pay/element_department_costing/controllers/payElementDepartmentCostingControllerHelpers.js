...
import { GENERIC_TECHNICAL_ERROR } from '../constants/payElementDepartmentCosting.constants.js';
import { firstValidationMessage } from '../validations/payElementDepartmentCosting.validation.js';
...
export async function withElementDepartmentCostingErrorHandling(res, work) {
  try {
    return await work();
  } catch (err) {
