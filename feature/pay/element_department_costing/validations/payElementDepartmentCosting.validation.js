...
export function parseElementDepartmentCostingGuidParam(raw) {
  return parseGuid(raw, 'elemDeptCostingGuid');
}
...
export function validateListElementDepartmentCostingQuery(query = {}, req) {
  const errors = [];
...
export function validateGetElementDepartmentCostingByGuidQuery(query = {}, req) {
  const errors = [];
  const enterprise_id = resolveRequiredEnterpriseIdFromQuery(req, query.enterprise_id, errors);
  throwIfErrors(errors);
  return { enterprise_id };
...
export function validateCreateElementDepartmentCostingBody(body = {}, _req) {
  const errors = [];
...
export function validateUpdateElementDepartmentCostingBody(body = {}, _req) {
  const errors = [];
...
export function validateDeleteElementDepartmentCostingBody(_body = {}, _query = {}) {
  return {};
}
