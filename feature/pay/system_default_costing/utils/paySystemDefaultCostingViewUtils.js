...
export function mapSystemDefaultCostingGridRow(row, parsedFlexfieldSegments, parsedFlexfieldSegmentsDetails) {
  const r = rowKeysUpper(row);
  return {
    system_default_costing_id: toNumberOrNull(r.SYSTEM_DEFAULT_COSTING_ID),
    system_default_costing_guid: normalizePayViewGuid(r.SYSTEM_DEFAULT_COSTING_GUID),
 ...
 */
export function mapSystemDefaultCostingDetailRow(row, parsedFlexfieldSegments, parsedFlexfieldSegmentsDetails) {
  const r = rowKeysUpper(row);
  return {
    system_default_costing_id: toNumberOrNull(r.SYSTEM_DEFAULT_COSTING_ID),
    system_default_costing_guid: normalizePayViewGuid(r.SYSTEM_DEFAULT_COSTING_GUID),
