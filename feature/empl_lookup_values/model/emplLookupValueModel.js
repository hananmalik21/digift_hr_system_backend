 ...
 * DISPLAY_SEQUENCE is automatically generated on create (next value per LOOKUP_TYPE).
 */
class EmplLookupValueModel {
  ...
  /**
   * Get next DISPLAY_SEQUENCE for a given LOOKUP_TYPE (and optional ENTERPRISE_ID).
   * Scoped per lookup type so each type has its own 1, 2, 3...
   */
  ...
  /**
   * Get all lookup values with optional filters and pagination
   */
  ...
  /**
   * Get a single lookup value by GUID
   */
  ...
  /**
   * Create a new lookup value. DISPLAY_SEQUENCE is auto-generated (next per LOOKUP_TYPE).
   */
  ...
  /**
   * Update a lookup value by GUID. DISPLAY_SEQUENCE can be optionally updated for reordering.
   */
