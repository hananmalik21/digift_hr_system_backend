 ...
 * Handles response formatting for STRUCTURE_LEVELS endpoints
 */
...
/**
 * Send list of structure levels
 * @param {Object} res - Express response object
 * @param {Object} req - Express request object
 * @param {Array} levels - Array of structure levels
...
/**
 * Send single structure level
 * @param {Object} res - Express response object
 * @param {Object} req - Express request object
 * @param {Object|null} level - Structure level object or null
 */
 ...
 * @param {Object} res - Express response object
 * @param {Object} req - Express request object
 * @param {Object} level - Created structure level
 */
 ...
 * @param {Object} res - Express response object
 * @param {Object} req - Express request object
 * @param {Object} level - Updated structure level
 */
 ...
 */
export function sendDeleted(res, req, message = 'Structure level deleted successfully', levelId = null) {
  const startTime = req._startTime || Date.now();
  const executionTime = Date.now() - startTime;
